...
#metodos similares:
[:text_field,:text_area,:url_field,:email_field,:number_field].each do |metodo|		#arreglo con métodos similares
	define_method metodo do |name,*args|
  	...
  	def errors
		if object.errors.any?
			content_tag :div, class:"red large-padding cream-text" do
